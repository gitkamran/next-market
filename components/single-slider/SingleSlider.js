    ...
    return (
        <div className="w-full h-full rounded-md shadow-[0_0_5px_#00000030] bg-neutral-100 flex flex-col items-center gap-2 p-2">
            ...
            <div className="flex flex-col gap-1 items-center justify-center h-full">
                <h2 className="text-center text-neutral-500 text-xs line-through">{data.price} تومان</h2>
                <h2 className="text-center text-green-600 text-sm">{data.main_price} تومان</h2>
            </div>
